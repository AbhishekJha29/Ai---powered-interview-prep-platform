    ...
    return (
        ...
        <div className='rounded-lg p-4 cursor-pointer relative' style={{ background: colors.bgcolor, }}>
            <div className='flex items-center'>
                <div className='flex-shrink-0 w-12 h-12 rounded-md flex items-center justify-center mr-4'>
                    <span className='text-lg font-semibold text-black'>{getInitials()}</span>
                </div>
            ...
            <button className='hidden group-hover:flex items-center gap-2 text-xs text-rose-500 text-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-rose-200 cursor-pointer absolute top-0 right-0' onClick={(e) => {
                e.stopPropagation();
                onDelete();
            }}><LuTrash2/></button>
        </div>
        ...
        <div className='px-3 pb-3'>
            <div className='flex items-center gap-3 mt-4'>
                ...
                <div className='text-[10px] font-medium text-black px-3 py-1 border-[0.5] border-gray-900 rounded-full'>{questions} Q&A</div>
                <div className='text-[10px] font-medium text-black px-3 py-1 border-[0.5] border-gray-900 rounded-full'>Last Updated: {lastUpdated}</div>
            </div>
